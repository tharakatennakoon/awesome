...
beautiful.wallpaper = '/home/tharaka/Pictures/Wallpapers/sunrise.png'
beautiful.useless_gap = 1

-- This is used later as the default terminal and editor to run.
-- terminal = 'x-terminal-emulator'
terminal = '/home/tharaka/Software/kitty/bin/kitty'
...
globalkeys = gears.table.join(
  ...
  end, { description = 'show Rofi App', group = 'launcher' }),
  awful.key({ modkey, 'Shift' }, 'p', function()
    awful.spawn.with_shell 'rofi -show combi'
  end, { description = 'show Rofi All', group = 'launcher' }),
  awful.key({ modkey }, 'c', function()
    awful.spawn.with_shell 'google-chrome --password-store=gnome-libsecret'
  end, { description = 'Start Google Chrome', group = 'client' })
)
